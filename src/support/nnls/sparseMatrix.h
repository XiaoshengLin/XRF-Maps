...
namespace nsNNLS {
  ...
  public:
    ...
    sparseMatrix(size_t r, size_t c, size_t nnz, size_t* ridx, size_t* cptr, _T* val) : matrix(r, c)
  ...
  public:
	...
	_T operator()   (size_t i, size_t j) {return 0.0}

    /// Get the (i,j) entry of the matrix
	_T get(size_t i, size_t j) { return 0.0; }
    ...
    size_t memoryUsage() { memory = nnz*sizeof(_T) + nnz*sizeof(size_t) + (ncols()+1)*sizeof(size_t); return memory;}
  };
}
